    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="glass w-full max-w-md rounded-2xl border border-emerald-200/20 p-8 shadow-2xl shadow-emerald-950/30">
        <div className="text-center mb-8">
          ...
          <h1 className="mb-2 bg-gradient-to-r from-emerald-700 via-sky-600 to-rose-600 bg-clip-text text-3xl font-bold text-transparent">
            Create Account
          </h1>
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            <span className="flex items-center gap-3">
              ...
              <span>{googleLoading ? 'Redirecting...' : googleEnabled ? 'Sign up with Google' : 'Google not configured'}</span>
            </span>
            {googleLoading ? (
          ...
          >
            <span className="flex items-center gap-3">
              ...
              <span>{githubLoading ? 'Redirecting...' : githubEnabled ? 'Sign up with GitHub' : 'GitHub not configured'}</span>
            </span>
            {githubLoading ? (
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="group flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-emerald-300 via-sky-300 to-amber-300 py-3 font-semibold text-slate-950 transition hover:shadow-lg hover:shadow-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-50"
          >
